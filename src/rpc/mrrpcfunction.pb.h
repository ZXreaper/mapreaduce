...
class AssignTaskRequest final :
 ...
 public:
  ...
  explicit PROTOBUF_CONSTEXPR AssignTaskRequest(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  void MergeFrom( const AssignTaskRequest& from) {
    AssignTaskRequest::MergeImpl(*this, from);
  }
  private:
...
class RPCTask final :
 ...
 public:
  ...
  ~RPCTask() override;
  explicit PROTOBUF_CONSTEXPR RPCTask(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class TaskCompletedReply final :
 ...
 public:
  ...
  explicit PROTOBUF_CONSTEXPR TaskCompletedReply(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  void MergeFrom( const TaskCompletedReply& from) {
    TaskCompletedReply::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
...
void AssignTaskRequest::set_assign_arg(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.assign_arg_.SetBytes(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline std::string* AssignTaskRequest::release_assign_arg() {
  ...
  return _impl_.assign_arg_.Release();
}
inline void AssignTaskRequest::set_allocated_assign_arg(std::string* assign_arg) {
  ...
  _impl_.assign_arg_.SetAllocated(assign_arg, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.assign_arg_.IsDefault()) {
...
void keyvalue::set_key_value_pair(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.key_value_pair_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void keyvalue::set_allocated_key_value_pair(std::string* key_value_pair) {
  ...
  _impl_.key_value_pair_.SetAllocated(key_value_pair, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.key_value_pair_.IsDefault()) {
...
void RPCTask::set_inputs(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.inputs_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void RPCTask::set_allocated_inputs(std::string* inputs) {
  ...
  _impl_.inputs_.SetAllocated(inputs, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
...
void RPCTask::set_outputs(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.outputs_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void RPCTask::set_allocated_outputs(std::string* outputs) {
  ...
  _impl_.outputs_.SetAllocated(outputs, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
...
inline ::mrrpc::keyvalue* RPCTask::mutable_intermediates(int index) {
  ...
  return _impl_.intermediates_.Mutable(index);
}
...
inline ::mrrpc::keyvalue* RPCTask::_internal_add_intermediates() {
  return _impl_.intermediates_.Add();
}
...
void TaskCompletedReply::set_completed_reply(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.completed_reply_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline std::string* TaskCompletedReply::release_completed_reply() {
  ...
  return _impl_.completed_reply_.Release();
}
inline void TaskCompletedReply::set_allocated_completed_reply(std::string* completed_reply) {
  ...
  _impl_.completed_reply_.SetAllocated(completed_reply, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.completed_reply_.IsDefault()) {
